...
def model_builder(model_dir,batch_size,**model_params):
    model = MPNNModel(mode='classification',
                  n_tasks=len(tasks),
                  batch_size=64, **model_params)
    return model
...
params_dict={'weight_decay':[10e-8, 10e-6,10e-4], 'learning_rate':[0.01, 0.001, 0.0001],
